...
int main() {
	...
	cout << "Multiplication calculator is running..." <<endl;
	cout << " " <<endl;
	...
	if (value1 > 0) {
		long long int allowed_max_value2 = LLONG_MAX / value1;
		cout << allowed_max_value2 <<endl;
	}
	else {
		long long int allowed_max_value22 = LLONG_MIN / value1;
		cout << allowed_max_value22 <<endl;
	}

	cout << "2. The minimum input allowed for value 2 is: " <<flush;
	if (value1 < 0) {
		long long int allowed_min_value2 = LLONG_MAX / value1;
		cout << allowed_min_value2 <<endl;
	}
	else {
		long long int allowed_min_value22 = LLONG_MIN / value1;
		cout << allowed_min_value22 <<endl;
	}
	cout << "3. Decimals are not allowed." <<endl;
	cout << " " << endl;
